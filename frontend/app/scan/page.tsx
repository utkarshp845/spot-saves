      ...
      <main className="container mx-auto px-4 py-12 max-w-2xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter your AWS Role ARN and External ID to begin scanning for cost savings opportunities.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Use our Terraform module to create this role. See terraform-onboarding/README.md
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-gray-500">
                  The External ID generated by the Terraform module
                </p>
              </div>
            ...
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-md">
              <h3 className="font-semibold mb-2">Don&apos;t have a Role ARN yet?</h3>
              <p className="text-sm text-gray-700 mb-3">
                Use our Terraform module to create a read-only IAM role in your AWS account:
              </p>
              <code className="text-xs bg-white p-2 rounded block">
                cd terraform-onboarding && terraform apply
              </code>
            </div>
          </CardContent>
        </Card>
